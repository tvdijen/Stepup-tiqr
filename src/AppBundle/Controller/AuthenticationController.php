...
class AuthenticationController extends Controller
{
    ...
    {
        $this->logger->notice('Request for authentication status');
        ...
        if ($isAuthenticated) {
            $this->logger->notice('The user is authenticated');

            return new JsonResponse(true);
        }
        $this->logger->notice('The user is not yet authenticated');
    ...
    private function logNotificationResponse($result, $notificationType, $notificationAddress)
    {
        if ($result) {
            $this->logger->info(sprintf(
                'Push notification successfully sent for type "%s" and address "%s"',
                $notificationType,
                $notificationAddress
            ));
